...
Выполнена визуальная проверка локальным Chromium на размерах 1440×900 и 390×844. На мобильном размере исправлено горизонтальное переполнение истории продаж; после пересборки frontend ширина страницы соответствует viewport.
